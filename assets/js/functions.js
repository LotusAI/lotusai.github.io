...
(function ($){
    ...
    jQuery(document).ready(function () {
       ...
       var lotusaitestimonialContainer = new Swiper('.lotusai-testimonial-container', {
            spaceBetween: 30,
            slidesPerView: 2,
            loop: true,
            // autoplay: {
       ...
       // to top js
        ...
        $(window).on("scroll",function() {
            ...
            if (scroll >= 100) {
                $(".lotusai-main-menu-area").addClass("fixed-menu animate slideInDown");
            } else {
                $(".lotusai-main-menu-area").removeClass("fixed-menu  animate slideInDown");
            }
        });
        ...
        $('.menu-bar').on("click", function(){
            $('.lotusai-main-menu-area').addClass('mobile-menu-open');
          })

        $('.close-button').on("click", function(){
            $('.lotusai-main-menu-area').removeClass('mobile-menu-open');
          })
